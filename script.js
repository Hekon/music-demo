var app = (function () {
    ...
    function deleteAlbum() {
        let doDelete = confirm("Ar tikrai norite istrinti?");
        if (doDelete) {
    ...
    function deleteAlbumFromDb(id) {
        ...
        if (!httpRequest) {
            ...
            httpRequest.onreadystatechange = deleteAlbumCallback;
    ...
    function deleteAlbumCallback() {
        if (httpRequest.readyState === XMLHttpRequest.DONE) {
            if (httpRequest.status === 200) {
                console.log("Albumas sekmingai istrintas");
            } else {
                console.log("Klaida");
            }
        }
    ...
    let sortBy = sortByElement.value;
    ...
    function sortAlbumsClick() {
        ...
        console.log("Rikiuok pagal: ", sortBy);
    }
